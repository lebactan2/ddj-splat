  ...
  <div id="ddj-container">
    <div id="ddj-controller">
      ...
      <div class="ddj-body">
        ...
        <div class="ddj-deck deck-left" id="deck-a">
          <div class="deck-main-col">
            <div class="deck-top">
              ...
              <div class="sync-section">
                ...
                <div class="bpm-display" id="bpm-a">120.0</div>
              </div>
            </div>
            <div class="deck-mid">
            ...
            <div class="deck-bot">
              ...
              <div class="pads-section">
                <div class="pads-modes">
                  <span class="pad-mode">HOT CUE</span>
                  <span class="pad-mode">BEAT LOOP</span>
                  <span class="pad-mode">BEAT JUMP</span>
                  <span class="pad-mode">SAMPLER</span>
                </div>
                <div class="pads-grid" id="pads-a">
                  <button class="pad-btn" data-pad="0"></button>
                  <button class="pad-btn" data-pad="1"></button>
                  <button class="pad-btn" data-pad="2"></button>
                  <button class="pad-btn" data-pad="3"></button>
                  <button class="pad-btn" data-pad="4"></button>
                  <button class="pad-btn" data-pad="5"></button>
                  <button class="pad-btn" data-pad="6"></button>
                  <button class="pad-btn" data-pad="7"></button>
                </div>
              </div>
            </div>
          </div>
          <div class="deck-side-col">
            ...
            <div class="tempo-wrapper">
              <input type="range" id="tempo-a" min="-100" max="100" value="0" class="tempo-slider">
            </div>
          </div>
        </div>
        ...
        <!-- MIXER -->
        <div class="ddj-mixer">
          <div class="mixer-header" style="align-items: flex-start;">
            <div class="flex-row" style="gap:8px; margin-right: 8px; align-items:center;">
              <label class="load-btn" style="background:#f97316; padding:2px 8px; margin:0;">LOAD 1<input type="file" id="file-a" accept=".ply,.splat"></label>
              <div class="flex-col" style="gap:4px;">
                <div id="file-a-name" class="deck-file-name" style="font-size:10px; color:#f97316; margin:0;">No file</div>
                <div class="flex-row" style="gap:2px; align-items:center;">
                  <span style="font-size:8px; font-weight:bold; color:#888;">MAX</span>
                  <input type="range" id="max-splats-slider-a" min="250000" max="1000000" step="10000" value="250000" style="width:40px;cursor:pointer;">
                  <span id="max-splats-val-a" style="font-size:8px; color:#888;">250k</span>
                </div>
              </div>
            </div>
            <div class="knob browse-knob" style="margin-top: 8px;"></div>
            <div class="flex-row" style="gap:8px; margin-left: 8px; align-items:center;">
              <label class="load-btn" style="background:#f97316; padding:2px 8px; margin:0;">LOAD 2<input type="file" id="file-b" accept=".ply,.splat"></label>
              <div class="flex-col" style="gap:4px;">
                <div id="file-b-name" class="deck-file-name" style="font-size:10px; color:#f97316; margin:0;">No file</div>
                <div class="flex-row" style="gap:2px; align-items:center;">
                  <span style="font-size:8px; font-weight:bold; color:#888;">MAX</span>
                  <input type="range" id="max-splats-slider-b" min="250000" max="1000000" step="10000" value="250000" style="width:40px;cursor:pointer;">
                  <span id="max-splats-val-b" style="font-size:8px; color:#888;">250k</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="mixer-channels">
            <div class="mixer-ch ch-1">
              ...
              <div class="fader-wrapper">
                <input type="range" class="ch-fader" id="vol-a" min="0" max="100" value="80">
              </div>
            ...
            <div class="mixer-ch ch-2">
              ...
              <div class="fader-wrapper">
                <input type="range" class="ch-fader" id="vol-b" min="0" max="100" value="100">
              </div>
              <span class="knob-label" style="margin-top:4px;">CH FADER</span>
            </div>
            
            <!-- MASTER FX (centered in mixer) -->
            <div class="mixer-fx" style="width: 80px;">
              <h3 class="fx-title" style="color: #f97316; font-size: 8px;">MASTER FX</h3>
              <div class="knob-cell">
              ...
              <div class="knob-cell" style="margin-top: 4px;">
                <span class="knob-label">BEAT</span>
                <div style="display:flex; align-items:center; gap:2px;">
                  <button id="btn-beat-prev-m" style="background:#111;border:1px solid #333;color:#fff;cursor:pointer;font-size:9px;padding:0 2px;">&lt;</button>
                  <span id="beat-value-m" style="font-size:9px;color:#fff;">1/2</span>
                  <button id="btn-beat-next-m" style="background:#111;border:1px solid #333;color:#fff;cursor:pointer;font-size:9px;padding:0 2px;">&gt;</button>
                </div>
              </div>
              <div class="knob-cell" style="margin-top: auto; margin-bottom: 4px;">
                <span class="knob-label">DEPTH</span>
                <input type="range" min="0" max="100" value="50" class="knob" id="fx-depth-m" style="width:28px; height:28px;">
              </div>
              <button id="btn-fx-toggle-m" class="fx-toggle-btn" style="padding:4px 2px; font-size:9px;">ON/OFF</button>
            </div>

              <!-- Utility items moved next to FX in DDJ -->
              <div class="flex-col" style="margin-top: 12px; border-top: 1px solid #333; padding-top: 8px; gap:8px;">
                <label style="font-size:10px; font-weight:bold; color:#888; display:flex; align-items:center; gap:4px; cursor:pointer;">
                  <input type="checkbox" id="chk-remove-bg" checked> REMOVE BG (IMG)
                </label>
                <div class="flex-col" style="gap:4px; align-items:stretch;">
                  <label style="font-size:10px; font-weight:bold; color:#888; display:flex; align-items:center; gap:4px; cursor:pointer;">
                    <input type="checkbox" id="chk-use-colab"> USE COLAB GPU
                  </label>
                  <input type="text" id="colab-url" placeholder="Paste loca.lt URL here..." style="background:#000; color:#fff; border:1px solid #333; font-size:10px; padding:4px; width:100%; box-sizing:border-box;">
                </div>
              </div>
        ...
        <div class="ddj-deck deck-right" id="deck-b">
          <div class="deck-main-col">
            <div class="deck-top">
              ...
              <div class="sync-section">
                ...
                <div class="bpm-display" id="bpm-b">120.0</div>
              </div>
            </div>
            <div class="deck-mid">
          ...
          <div class="deck-side-col">
            <span class="tempo-label">TEMPO</span>
            <div class="tempo-wrapper">
              <input type="range" id="tempo-b" min="-100" max="100" value="0" class="tempo-slider">
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="ddj-footer">
        <div id="status">DDJ-400 Layout Ready</div>
        <div class="utility-buttons" style="display:flex; align-items:center; gap:8px;">
          <label style="font-size:10px; font-weight:bold; color:#888;">OPACITY 
            <input type="range" id="ui-opacity" min="10" max="100" value="100" class="ui-opacity-slider">
          </label>
...
const ddjController = document.querySelector('#ddj-controller');
...
uiOpacity.addEventListener('input', () => {
  ddjController.style.opacity = uiOpacity.value / 100;
});
...
function scaleUI() {
  ...
  const targetHeight = 500; // Approximate needed height
  
  let scaleX = containerWidth / (targetWidth + 40);
  ...
  if (ddjController) {
    ddjController.style.transform = `scale(${finalScale})`;
    ddjController.style.transformOrigin = 'bottom center';
  }
}
scaleUI(); // Initial scale
...
function resizeViewer() {
  const wrapper = document.querySelector('#viewer-container');
  if (wrapper && viewer) {
